...
1. You start in the Teamcenter service document, where you configure your connection and create integrations using the visual integration editors.
...
3. At runtime, your microflows use the TcConnector's published microflows and Java actions to communicate with Teamcenter's SOA layer, using the authentication method you configured.
